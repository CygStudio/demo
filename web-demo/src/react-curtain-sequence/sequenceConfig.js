export const sequenceOrder = [
  { key: 'character', delay: 0.2, duration: 2.7, y: 24 },
  { key: 'cake', delay: 1.5, duration: 2.1, y: 36 },
  { key: 'balloons', delay: 2.6, duration: 2.4, y: 44 },
  { key: 'gifts', delay: 3.8, duration: 2.1, x: 40 },
  { key: 'ghost', delay: 4.9, duration: 2.1, x: 20, y: -32 },
  { key: 'mascot', delay: 5.9, duration: 1.65, scale: 1.08 },
]
